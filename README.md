...
Atualmente graduando em Ciência da Computação e em Análise e Desenvolvimento de Sistemas pelo Instituto Federal de São Paulo (IFSP). Minha trajetória acadêmica e profissional é direcionada para a intersecção entre tecnologia, automação de processos e inteligência de dados, buscando sempre o desenvolvimento de soluções eficientes e de alto impacto.

### 🎯 Foco de Atuação:
- **Gestão e Visualização de Dados:** Experiência na estruturação, análise e criação de dashboards estratégicos utilizando SQL Server, Excel e Power BI para facilitar a tomada de decisão.
- **Automação de Processos:** Aplicação de lógica de programação para a otimização de rotinas administrativas e operacionais, visando a redução de trabalho manual e o ganho de produtividade.
- **Perfil Analítico:** Visão estratégica e orientada a dados, com forte interesse em planejamento financeiro, economia e análises de longo prazo.
